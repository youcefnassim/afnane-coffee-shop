...
export const MAMAKA_PRODUCTS = [
  ...
  {
    category_id: "sucre",
    name: { fr: "Brioche Duo Gourmand", en: "Gourmet Duo Brioche", ar: "بريوش ثنائي جورمانd" },
  ...
  },
  {
    ...
    description: { fr: "Espresso et lait frais versés sur de la glace", en: "Espresso shot and cold milk over ice", ar: "إسبريسو وحليب بارd يسكب فوق الثلج" },
    price: 500,
    media_type: "image",
    media_url: "https://images.unsplash.com/photo-1517701604599-bb29b565090c?q=80&w=800",
    available: true,
  ...
  {
    category_id: "omelettes",
    name: { fr: "Omelette Crémeuse", en: "Creamy Omelette", ar: "أومليt كريمية" },
